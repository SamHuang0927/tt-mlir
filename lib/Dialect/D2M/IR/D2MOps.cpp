...
// Both view & stream set these to false?
...
// Ops that create a new tensor doesn't alias anything (empty/full/generic).
// Return empty as it's not aliasing any/every single input?
