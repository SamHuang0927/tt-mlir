...
// CHECK-SAME: (tensor<1x64x1xf32>) -> tensor<1x1x64xf32>
func.func @pure_permute_trailing_ones_identity_swap(%arg0: tensor<64x1x1xf32>) -> tensor<1x1x64xf32> {
  %0 = "ttir.reshape"(%arg0) <{shape = [1 : i32, 1 : i32, 64 : i32]}> : (tensor<64x1x1xf32>) -> tensor<1x1x64xf32>
  return %0 : tensor<1x1x64xf32>
}

// ============================================================================
// Pure Permute: Sub-case A (output has trailing 1, input doesn't)
...
// CHECK-LABEL: @pure_permute_add_trailing_1_2d
// CHECK: "ttir.permute"(%arg0) <{permutation = array<i64: 1, 0>}>
// CHECK-SAME: (tensor<1x128xf32>) -> tensor<128x1xf32>
// CHECK-NOT: "ttir.reshape"
func.func @pure_permute_add_trailing_1_2d(%arg0: tensor<1x128xf32>) -> tensor<128x1xf32> {
...
// CHECK-LABEL: @pure_permute_add_trailing_1_3d
// CHECK: "ttir.permute"(%arg0) <{permutation = array<i64: 0, 2, 1>}>
// CHECK-SAME: (tensor<1x1x64xf32>) -> tensor<1x64x1xf32>
// CHECK-NOT: "ttir.reshape"
func.func @pure_permute_add_trailing_1_3d(%arg0: tensor<1x1x64xf32>) -> tensor<1x64x1xf32> {
...
// CHECK-LABEL: @pure_permute_add_trailing_1_rank_increase
...
func.func @pure_permute_add_trailing_1_rank_increase(%arg0: tensor<32x8x17xf32>) -> tensor<32x8x17x1xf32> {
  %0 = "ttir.reshape"(%arg0) <{shape = [32 : i32, 8 : i32, 17 : i32, 1 : i32]}> : (tensor<32x8x17xf32>) -> tensor<32x8x17x1xf32>
  return %0 : tensor<32x8x17x1xf32>
}

// ============================================================================
// Pure Permute: Sub-case A fallback (output swap identity, use input swap)
...
// CHECK-LABEL: @pure_permute_output_swap_identity
// CHECK: "ttir.permute"(%arg0) <{permutation = array<i64: 1, 0>}>
...
func.func @pure_permute_output_swap_identity(%arg0: tensor<1x16xf32>) -> tensor<1x16x1x1xf32> {
  %0 = "ttir.reshape"(%arg0) <{shape = [1 : i32, 16 : i32, 1 : i32, 1 : i32]}> : (tensor<1x16xf32>) -> tensor<1x16x1x1xf32>
  return %0 : tensor<1x16x1x1xf32>
}

// ============================================================================
// Singleton Permute: trailing 1s become leading 1s with a genuine reshape
// Strategy: collapse to (X, 1), swap to (1, X), reshape to output.
// ============================================================================

// [128, 4, 1] -> [1, 512]: reshape to [512, 1], permute [1, 0]
// CHECK-LABEL: @singleton_permute_collapse_and_swap
...
func.func @singleton_permute_collapse_and_swap(%arg0: tensor<128x4x1xf32>) -> tensor<1x512xf32> {
